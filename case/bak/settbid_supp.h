...
void mvitem_spcontactrule(struct SpContactRuleStruct *pi,
	struct SpContactRuleStruct *po);
int CalcSpSettFee(int t,int x,int br,int mt,int mo,
	int iContactID,char sStartTime[]);
