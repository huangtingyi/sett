...
24,0,0,2,0,0,17,53,0,0,1,1,0,1,0,1,97,0,0,
43,0,0,2,0,0,21,57,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
66,0,0,1,0,0,21,63,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
};
...

{
                ...
                /* EXEC SQL PREPARE RU_IMSIESN_TICKETUCR_1 FROM :statement; */ 

{
                ...
                /* EXEC SQL FOR :iCurPos EXECUTE RU_IMSIESN_TICKETUCR_1 USING
                                :pTarget->asYMap,
                                :pTarget->asRowID; */ 
...

{
                ...
                if(CheckSqlResult("Dyn update U_MSISDN_IMSI_ESN_1")<0) return -1;
