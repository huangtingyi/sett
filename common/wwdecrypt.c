...
static void desinit(char *key)				/* initialize all des arrays	*/
{
/*	int i,j,k;*/
#ifdef DEBUG
...
{
	int i,l;
	char inblocktemp[9], outblocktemp[9],*temp;
	...
	{	
		...
		dedes(inblocktemp,outblocktemp);
                outblocktemp[8]=0;

		if (i==l-8){
			TrimRight(outblocktemp);
		}
